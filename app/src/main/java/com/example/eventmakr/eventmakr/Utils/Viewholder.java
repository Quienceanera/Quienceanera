...
public class Viewholder extends RecyclerView.ViewHolder {
    public TextView mTextViewVendorName, mTextViewVendorPopularItems, mTextViewVendorCategory, mTextViewChat, mTextViewChatUser, mTextViewChatDetailUser, mTextViewChatDate, mTextViewMenuItemName, mTextViewMenuItemDescription, mTextViewMenuItemPrice, mTextViewVendorProductItemName, mTextViewVendorProductItemPrice, mTextViewItemsName, mTextViewItemsQuantity, mTextViewItemsPrice;
    ...
    public CardView mCardViewChat, mCardViewChatUser, mCardViewChatDelete, mCardViewChatDetail, mCardViewVendorItem;
    ...
    public Viewholder(View itemView) {
        ...
        mTextViewVendorCategory = (TextView) itemView.findViewById(R.id.textViewVendorCategory);
